...
if __name__ == '__main__':
  cwd = Path(os.getcwd())
  assert cwd.name=="example_ds", "Please run the script directly from the 'example_ds' directory"

  parser = argparse.ArgumentParser(description=__doc__, formatter_class=argparse.RawDescriptionHelpFormatter)
  parser.add_argument('--image_list', type=str, default="images.txt", help=('Filename that contains the split + image IDs of the images to download. Check the document'))
  parser.add_argument('--num_processes', type=int, default=5, help='Number of parallel processes to use (default is 5).')
  parser.add_argument('--download_folder', type=str, default="../flask/db_images/open_images_dataset", help='Folder where to download the images.')
